CREATE OR REPLACE PROCEDURE `birkbeck-msc-project-422917.preparation_layer.sproc_update_league_ranking` ()

BEGIN

TRUNCATE TABLE preparation_layer.league_ranking;

INSERT preparation_layer.league_ranking
...
form_match_points_last_5_away_games AS form_away,
form_match_points_last_5_home_and_away_both_games AS form_home_and_away,
match_flag,
match_team_points

FROM `birkbeck-msc-project-422917.preparation_layer.view_league_match_points`
