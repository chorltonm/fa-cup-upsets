CREATE OR REPLACE VIEW `birkbeck-msc-project-422917.analysis_layer.view_fa_cup_scores` AS
...
FROM `birkbeck-msc-project-422917.analysis_layer.view_round_3_fa_cup_matches` 

--WHERE season_year = '10/11'
